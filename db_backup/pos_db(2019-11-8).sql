/*
 ...
 Source Server         : 202.148.9.52
 Source Server Type    : MySQL
 Source Server Version : 50560
 Source Host           : 202.148.9.52:3306
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `code_generators` VALUES (1, 'Format Kode Pasien', 'customer', 'patient_code', 'yyyy.mm.dd.urutan_angka[00001]', 'year', '2019-07-24 13:05:08', '2019-07-24 14:09:34');
...
CREATE TABLE `daily_schedules`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1070 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `diagnose_drugs`  (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 63 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `diagnosedrug_sales`  (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `diagnoses`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `gudang`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `menu_privileges`  (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 717 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
INSERT INTO `menu_privileges` VALUES (693, 2, 1, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (694, 2, 3, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (695, 2, 2, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (696, 2, 6, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (697, 2, 41, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (698, 2, 27, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (699, 2, 13, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (700, 2, 28, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (701, 2, 32, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (702, 2, 33, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (703, 2, 35, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (704, 2, 37, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (705, 2, 38, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (706, 2, 39, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (707, 2, 20, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (708, 2, 17, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (709, 2, 29, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (710, 2, 30, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (711, 2, 31, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (712, 2, 34, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (713, 2, 36, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (714, 2, 42, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (715, 2, 22, '1', '1', '1', '1', '2019-11-07 13:03:14');
INSERT INTO `menu_privileges` VALUES (716, 2, 16, '1', '1', '1', '1', '2019-11-07 13:03:14');
...
CREATE TABLE `menus`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
INSERT INTO `menus` VALUES (42, 17, 'customer', 'customer', 'Customer', NULL, 2, '9', 'adminpanel', '0', '2019-11-07 13:02:39', NULL);
...
CREATE TABLE `purchase`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `purchase_faktur`  (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 132 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `purchase_return`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `sales`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sales
-- ----------------------------
INSERT INTO `sales` VALUES (54, 'XIX.11.VII.001', NULL, 2, 62500.00, '2019-11-07 05:58:28', '2019-11-07 15:18:04');
...
CREATE TABLE `sales_item`  (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 111 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sales_item
-- ----------------------------
INSERT INTO `sales_item` VALUES (108, 54, 2, '3800065711131', 'Barang A', 15000.00, 2, 30000.00, '2019-11-07 15:18:05');
INSERT INTO `sales_item` VALUES (109, 54, 3, '3800065711132', 'Barang B', 20000.00, 1, 20000.00, '2019-11-07 15:18:05');
INSERT INTO `sales_item` VALUES (110, 54, 4, '3800065711133', 'Barang C', 12500.00, 1, 12500.00, '2019-11-07 15:18:05');
...
CREATE TABLE `user_privileges`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Compact;
...
INSERT INTO `user_privileges` VALUES (11, 11, 5, '2019-11-05 11:41:59', '2019-11-07 12:33:47');
INSERT INTO `user_privileges` VALUES (12, 12, 5, '2019-11-07 12:53:41', '2019-11-07 12:57:34');
INSERT INTO `user_privileges` VALUES (13, 13, 5, '2019-11-07 12:59:40', NULL);
INSERT INTO `user_privileges` VALUES (14, 14, 5, '2019-11-07 13:04:55', NULL);
INSERT INTO `user_privileges` VALUES (15, 15, 5, '2019-11-07 13:07:45', '2019-11-07 13:08:26');
...
INSERT INTO `users` VALUES (15, 'mawar', '$2y$12$Ocyq0prjh.RrF2Bqpq4FUecTDdnMVI/FY28/UQh.J2A4D7ZpEgrMW', 'mawar', '2019-11-07 13:07:44', '2019-11-07 13:08:26');

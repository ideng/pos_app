...
<table id="t01" style="width:100%">
    ...
    if (!empty($penjualan)) {
        foreach ($penjualan as $penjualans) {
            ...
            <tr id="t01">
                <td id="t01">
                    <?php echo $penjualans->name; ?>
                </td>
                <td id="t01">
                    <?php echo $penjualans->quantity; ?>
                </td>
                <td id="t01">
                    <?php echo number_format($penjualans->price, '2', ',', '.'); ?>
                </td>
                <td id="t01">
                    <?php echo number_format($penjualans->subtotal, '2', ',', '.'); ?>
                </td>
            </tr>
    <?php
        }
    ...
    <tr>
        ...
        <td id="t01">
            <label><?php echo number_format($row->total_price, '2', ',', '.'); ?></label>
        </td>
    </tr>
</table>
<table style="width:100%">

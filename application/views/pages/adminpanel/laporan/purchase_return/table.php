...
<div class="input-retur">
	<div class="col-md-2">
		<label for="">&nbsp</label><br />
		<label for="">Pilih Retur :</label>
	</div>
	<div class="col-md-3">
		<label for="">No Retur</label>
		<input type="text" name='no_retur' id='no_retur' class="form-control" value="" required>
	</div>
	<div class="col-md-3">
		<label for="">&nbsp</label>
		<input type="hidden" name='no_retur_id' id='no_retur_id' class="form-control date-picker" value="" required>
	</div>
	<div class="col-md-4">
		<label for="">&nbsp</label>
		<label for="">&nbsp</label>
	</div>
	<button type="button" id="btnDetailTransaksiRetur" class="btn btn-primary" data-toggle="modal" data-target="#myModa">
		Detail Transaksi
	</button>
	<?php
	$this->load->view('pages/' . $class_link . '/components/retur_purchase_typeahead');
	?>
</div>
<hr>
<div class="modal fade" id="myModa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div id="printThis3" class="modal-retur"></div>
			<button type="button" id="Print3" class="btn btn-primary">Print</button>
		</div>
	</div>
</div>
<div>
	<H3 style="text-align:center">Data Retur Pembelian Hari Ini</H3>
</div>

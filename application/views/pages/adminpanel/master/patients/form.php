                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="form-group">
                                    <label for="patient_code">Kode Pasien</label>
                                    <input type="text" name="patient_code" id="patient_code" class="form-control" placeholder="Kode Pasien" value="<?php echo $row->patient_code; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-xs-4">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group text-center">
                                    <?php
                                    $img_dir = 'assets/admin_lte/dist/img/' . $page . '/' . $row->image;
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="image">Foto Pasien</label>

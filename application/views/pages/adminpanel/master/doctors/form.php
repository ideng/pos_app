                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="form-group">
                                    <label for="doctor_id">Kode Doktor</label>
                                    <input type="text" name="doctor_id" id="doctor_id" class="form-control" placeholder="Kode Doktor" value="<?php echo $row->doctor_id; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-xs-4">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group text-center">
                                    <?php
                                    $img = empty($row->image) ? 'assets/admin_lte/dist/img/avatar.png' : 'assets/admin_lte/dist/img/' . $page . '/' . $row->image ;
                                    ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="image">Foto Doktor</label>

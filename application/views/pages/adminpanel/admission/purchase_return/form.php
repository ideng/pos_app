...
<div class="box box-primary box-form">
                        ...
                        <div class="col-md-5" style="margin-top: 15px;">
                            <div class="form-group">
                                ...
                                <div id="scrollable-dropdown-menu">
                                    <input type="text" name="no_faktur" id="no_faktur" class="form-control" placeholder="No Faktur" value="<?php echo $row->no_faktur; ?>" required autofocus>
                                </div>
                            </div>
                        </div>
    ...
    <?php
    $this->load->view('pages/' . $class_link . '/components/faktur_typeahead');

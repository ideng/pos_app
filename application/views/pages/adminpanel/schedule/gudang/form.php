                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Nama Barang" value="<?php echo $row->drug_name; ?>" autofocus required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="name">Barcode</label>
                                <input type="text" name="barcode" id="barcode" class="form-control" placeholder="Barcode" value="<?php echo $row->barcode; ?>" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="type_drug">Kategori Barang</label>

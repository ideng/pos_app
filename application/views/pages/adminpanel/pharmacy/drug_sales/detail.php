...
<div class="box box-info box-form">
    <div class="box-header with-border">
        <h3 class="box-title"><?php echo 'Detail ' . ucwords(str_replace('_', ' ', $title)); ?></h3>
        ...
        <div class="form-container" style="display: none;">
            <form method="POST" id="formSubmit">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-10"><?php echo $row->no_faktur_checkup; ?></div>
                </div>
                <div class="row">
                    <label for="medical_record_id" class="col-xs-2">No. Rekam Medis :</label>
                    <div class="col-xs-10"><?php echo $row->medical_record_id; ?></div>
                </div>
                <div class="row">
                    <label for="patient_civilian_id" class="col-xs-2">NIK :</label>
                    <div class="col-xs-10"><?php echo $row->patient_civilian_id; ?></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-10"><?php echo format_date($row->date_in, 'd-m-Y'); ?></div>
                </div>
                <div class="row">
                    <label for="poly_name" class="col-xs-2">Nama Poli :</label>
                    <div class="col-xs-10"><?php echo $row->poly_name; ?></div>
                </div>
                <div class="row">
                    <label for="doctor_name" class="col-xs-2">Nama Dokter :</label>
                    <div class="col-xs-10"><?php echo $row->doctor_name; ?></div>
                </div>
                <div class="row">

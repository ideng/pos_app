    ...
    <div class="box-body">
        ...
        <div class="form-container" style="display: none;">
            <form method="POST" id="formSubmit">
                ...
                <div class="row">
                    <label for="nama_obat" class="col-xs-2">Nama Obat :</label>
                    <div class="col-xs-10"><?php echo $row->nama_obat; ?></div>
                </div>
                <div class="row">
                    <label for="harga_beli" class="col-xs-2">Harga Beli :</label>
                    <div class="col-xs-10"><?php echo $row->purchase_price; ?></div>
                </div>
                <div class="row">
                    <label for="quantity" class="col-xs-2">Jumlah :</label>
                    <div class="col-xs-10"><?php echo $row->quantity; ?></div>
                </div>
                <div class="row">
                    <label for="subtotal" class="col-xs-2">subtotal :</label>
                    <div class="col-xs-10"><?php echo $row->subtotal; ?></div>
                </div>
                <div class="row">

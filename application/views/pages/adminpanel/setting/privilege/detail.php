    ...
    <div class="box-body">
        ...
        <div class="form-container" style="display: none;">
            <form method="POST" id="formSubmit">
                ...
                <div class="row">
                    <label for="name" class="col-xs-2">Nama Hak Akse :</label>
                    <div class="col-xs-10"><?php echo $row->name; ?></div>
                </div>
                <div class="row">
                    <label for="level" class="col-xs-2">Level Hak Akses :</label>
                    <div class="col-xs-10"><?php echo $row->level; ?></div>
                </div>
                <div class="row">
                    <label for="module" class="col-xs-2">Modul :</label>
                    <div class="col-xs-10"><?php echo empty_string(ucwords($row->module), '-'); ?></div>
                </div>
                <div class="row">

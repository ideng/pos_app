...
function get_client_ip()
{
    ...
    if (getenv('HTTP_CLIENT_IP')) :
        $ipaddress = getenv('HTTP_CLIENT_IP'); elseif (getenv('HTTP_X_FORWARDED_FOR')) :
        $ipaddress = getenv('HTTP_X_FORWARDED_FOR'); elseif (getenv('HTTP_X_FORWARDED')) :
        $ipaddress = getenv('HTTP_X_FORWARDED'); elseif (getenv('HTTP_FORWARDED_FOR')) :
        $ipaddress = getenv('HTTP_FORWARDED_FOR'); elseif (getenv('HTTP_FORWARDED')) :
        $ipaddress = getenv('HTTP_FORWARDED'); elseif (getenv('REMOTE_ADDR')) :
...
function min_string($str = '', $replacement = '-')
{
    ...
    if ($str <= '3' && $str > '0') :
        $string = $replacement; elseif ($str >= '4') :
        $string = '<span class=\'label label-info\'>Tersedia</span>'; elseif ($str == '0') :
        $string = '<span class=\'label label-danger\'>Habis</span>'; elseif ($str < '0') :
        $string = '<span class=\'label label-default\'>Error</span>'; else :
        $string = $str;
    endif;
    return $string;
}

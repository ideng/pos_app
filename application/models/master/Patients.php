...
class Patients extends CI_Model {
	...
	public function ssp_table()
	{
		...
		$data['columns'] = array(
			...
			array( 'db' => 'patient_code', 'dt' => 3, 'field' => 'patient_code',
	...
	public function post_data(array $post_data)
	{
		...
		$patient_code = empty($post_data['patient_code']) ? $this->code_generators->generate_code('patients') : $post_data['patient_code'] ;
